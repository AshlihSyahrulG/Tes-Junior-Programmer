...
const theadClass =
  'py-4 px-3 bg-warning-500 border-2 border-table-color text-white font-normal ';
              ...
              {info.column.id === 'no' || info.column.id === 'action' ? (
                ...
                <div className="flex justify-end">
                  <div className="flex flex-col justify-center">
                    <button
                      className="h-fit w-fit hover:bg-warning-400 p-1 rounded transition"
              ...
              {table.getRowModel().rows.map((row) => (
                <tr key={row.id}>
                  {row.getVisibleCells().map((cell) => (
                    <td
                      key={cell.id}
                      className=" px-2 py-2 h-16 border-2 border-warning-400"
                    >
                      {flexRender(
