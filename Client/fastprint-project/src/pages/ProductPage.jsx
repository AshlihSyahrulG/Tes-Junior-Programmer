...
function ProductPage() {
  ...
  return (
    <>
      <div className="flex justify-between h-[80px] bg-warning-600 fixed w-screen top-0 left-0 z-[1000]">
      ...
      <div className="flex justify-between my-2">
        ...
        <div className="flex gap-4">
          <button
            ...
            className="flex font-semibold justify-center text-center bg-info-500 hover:bg-info-600 p-2 px-4 rounded-xl text-white"
          >
